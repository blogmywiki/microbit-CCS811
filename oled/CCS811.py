...
"""
# Port of https://github.com/Notthemarsian/CCS811 to micro:bit MicroPython 
# which lacks the readfrom_mem and writefrom_mem instructions.
# Also on the micro:bit i2c pin numbers are fixed so I removed passing them
...
class CCS811(object):
    ...
    def __init__(self, addr=90):
        ...
        # on mb we need to write address then read 1 byte
        i2c.write(90, bytearray([0x20]))
        hardware_id = i2c.read(90, 1)
        ...
        i2c.write(90, bytearray([0x00]))
        status = i2c.read(90, 1)
...
#       self.i2c.writeto_mem(self.addr, 0x01, bytearray([0b00011000]))
    ...
    def data_ready(self):
        ...
        if (status[0] >> 3) & 0x01:
            ...
            i2c.write(90, bytearray([0x02]))
            register = i2c.read(90, 4)
#           register = self.i2c.readfrom_mem(self.addr, 0x02, 4)
    ...
    def get_baseline(self):
        i2c.write(90, bytearray([0x11]))
        register = i2c.read(90, 2)    
    ...
    def put_baseline(self,HB,LB):
        ...
        register[0] = HB
        register[1] = LB
        i2c.write(90, bytearray([0x11,register]))
    ...
    def put_envdata(self,humidity,temp):
        ...
        i2c.write(90, bytearray([0x05,envregister]))
